      ...
      <div className={style.wrapper} id='contact'>
        ...
        <div className={style.rightbox}>
              ...
              <p>
                ...
                <span>+91 9990906271</span>
              </p>
              <p>
                <MdEmail className={style.icon}></MdEmail>
                <span>bhawnask32@gmail.com</span>
              </p>
            </div>
            ...
            <div className={style.socialicon}>
              ...
              <a target="_blank" href="https://github.com/Bhawna32">
                <BsGithub className={style.sicon}></BsGithub>
              </a>
              <a target="_blank" href="https://www.linkedin.com/in/bhawna-singh-a08a4923a/">
